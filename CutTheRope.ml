...
let main =
	...
	(* écran de chargement *)
	chargement 0.;
	let gif1  = load_brc_set 5 "Images\\Dragon\\Win" in
	chargement 0.1;
	let gif2  = load_brc_set 5 "Images\\Dragon\\Waiting" in
	chargement 0.2;
	let gif3  = load_brc_set 4 "Images\\Dragon\\Loose" in
	chargement 0.3;
	let ball  = load_brc "Images\\Ball\\Test" in
	chargement 0.4;
	let back  = load_brc "Images\\Decor\\Back" in
	chargement 0.7;
	let front = load_brc "Images\\Decor\\Front" in
	chargement 1.;
